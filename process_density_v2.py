#!/usr/bin/env python3
"""
Script mejorado para procesar datos de BigQuery con múltiples resoluciones H3
"""
    ...
    try:
        ...
        for i, record in enumerate(raw_data):
            if i % 10000 == 0:
                ...
                print(f"   Procesados {i:,}/{len(raw_data):,} ({progress:.1f}%)")
        ...
        print(f"📅 Fechas disponibles: {start_date} a {end_date} ({date_count} días)")
        
        print(f"✅ Procesamiento completo: {valid_count:,} entregas válidas")
        ...
        print(f"   Fechas disponibles: {date_count} días")
